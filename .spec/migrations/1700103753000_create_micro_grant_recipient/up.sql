BEGIN;
    ...
    alter table public.micro_grant_recipient add constraint pk_jnpbpd1anfnpfodbhjkytk primary key (strategy, recipient_id, chain_id);
    ...
    COMMENT ON TABLE public.micro_grant_recipient IS E'@foreignKey (strategy, chain_id) references public.micro_grant (strategy, chain_id)|@fieldName microGrant|@foreignFieldName microGrantRecipients';
COMMIT;