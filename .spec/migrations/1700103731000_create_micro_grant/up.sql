BEGIN;
    ...
    COMMENT ON TABLE public.micro_grant IS E'@foreignKey (pool_id, chain_id) references public.pool (pool_id, chain_id)|@fieldName pool|@foreignFieldName microGrant';
COMMIT;